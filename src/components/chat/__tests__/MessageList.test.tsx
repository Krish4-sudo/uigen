...
test("MessageList renders messages with parts", () => {
  ...
  // ToolCallBadge renders a friendly label; with empty args the filename falls back to the tool name
  expect(screen.getByText("Editing str_replace_editor")).toBeDefined();
});
